    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("acao").contains("pesquisar")) {
            ...
            try {
                ...
                if (usuario.isEmpty()) {
                    ...
                    response.setHeader("Refresh", "2; url=\"v_pesquisarUsuario.jsp\"");
                    ...
                    // Redireciona para a página de mensagem 
                    RequestDispatcher redireciona = request.getRequestDispatcher("v_listagemUsuario.jsp");
                    redireciona.forward(request, response);
                }
        ...
        if (request.getParameter("acao").contains("editar")) {
            ...
            try {
                ...
                RequestDispatcher redireciona = request.getRequestDispatcher("v_editarUsuario.jsp");
                redireciona.forward(request, response);
        ...
        if (request.getParameter("acao").contains("listar")) {
            ...
            try {
                ...
                if (usuario.isEmpty()) {
                    ...
                    // Redireciona para a página de mensagem
                    RequestDispatcher redireciona = request.getRequestDispatcher("v_cadastarUsuario.jsp");
                    redireciona.forward(request, response);
                } else {
